...
extensively used for various image manipulation operations, including translation, scaling, rotation, 
shearing, and reflection. Mathematically, it is represented as: $ y = Ax + b $
...
within its new dimensions. The \texttt{warpAffine} function in OpenCV is widely used to perform 
