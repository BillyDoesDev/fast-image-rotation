...
// to get your libs and headers later, do:
// ./darotator -o . -g auto_schedule_gen -f auto_schedule_false -e static_library,h,schedule target=host -p ../Halide-17.0.1-x86-64-linux/lib/libautoschedule_mullapudi2016.so autoscheduler=Mullapudi2016
// ./darotator -o . -g auto_schedule_gen -f auto_schedule_true -e static_library,h,schedule -p ../Halide-17.0.1-x86-64-linux/lib/libautoschedule_mullapudi2016.so target=host autoscheduler=Mullapudi2016 autoscheduler.parallelism=32 autoscheduler.last_level_cache_size=16777216 autoscheduler.balance=40
